...
HandleTable.prototype.insertHead =function(){
    this.thead = this.table.createTHead();
    return new EFDEF_.fn(this.thead);
}
HandleTable.prototype.insertHeadRow = function () {
    var no = arguments[0] != null ? arguments[0] : -1;
    this.tr = this.thead.insertRow();
    return new EFDEF_.fn(this.tr);
}
HandleTable.prototype.insertHeadCell = function () {
    var no = arguments[0] != null ? arguments[0] : -1;
    this.td = this.tr.insertCell(no);
    return new EFDEF_.fn(this.td);
}
