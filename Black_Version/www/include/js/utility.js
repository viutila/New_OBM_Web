...
function setIdBorderRadius() {
    ...
    var type = args[2] ? args[2] : 0;
    if (type == 1) {
        getIdStyle(id).borderTopLeftRadius = val;
    } else if (type == 2) {
        getIdStyle(id).borderTopRightRadius = val;
    } else if (type == 3) {
        getIdStyle(id).borderBottomLeftRadius = val;
    } else if (type == 4) {
        getIdStyle(id).borderBottomRightRadius = val;
    } else {
        getIdStyle(id).borderRadius = val;
    }
}
...
function getIdBorderRadius(){
	...
	var type = args[1]?args[1]:0;
	if(type == 1){
		return getIdStyle(id).border-top-left-radius;
	}else if(type == 2){
		return getIdStyle(id).border-top-right-radius;
	}else if(type == 3){
		return getIdStyle(id).border-bottom-right-radius;
	}else if(type == 4){
		return getIdStyle(id).border-bottom-left-radius;
	}else{
		return getIdStyle(id).border-radius;
	}
}
...
EFDEF_.fn = function(obj){
	...
	if(obj)
	{
        ...
        this.borderRadius = function () {
            return this.exe(arguments, 0, setIdBorderRadius, getIdBorderRadius);
        };
